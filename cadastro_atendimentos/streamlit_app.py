...
<div class="header-banner">
    <h1>📱 Sistema de Atendimentos — SMB</h1>
...
with tab1:
    ...
    if not nomes_vendedores:
        ...
        with st.form("form_atendimento", clear_on_submit=True):
            ...
            with col1:
                atendente = st.selectbox("Vendedor *", options=nomes_vendedores)
            with col2:
            ...
            with col6:
                email_cliente = st.text_input("E-mail do Cliente (opcional)", placeholder="cliente@email.com")
...
with tab2:
    ...
    <div style="background:linear-gradient(135deg,#034EA2,#0369a1);
        ...
        <h3 style="margin:0">💳 Registro de Atendimento com Pagamento</h3>
    ...
    with st.form("form_pagamento", clear_on_submit=True):
        ...
        with col_os2:
            detalhe_pedido = st.text_area("Detalhe do Pedido", placeholder="Descreva o produto, serviço…", height=100)
    ...
    if btn_pagar:
        ...
        if erros_pag:
            ...
            dados_pag = {
                "numero_os": numero_os.strip(), "detalhe_pedido": detalhe_pedido.strip(),
            ...
            try:
                ...
                c2.metric("Cliente", dados_pag["nome_cliente"])
                c3.metric("Pagamento", dados_pag["tipo_pagamento"])
                cc1, cc2, cc3 = st.columns(3)
                cc1.metric("Valor Produto", f"R$ {dados_pag['valor_produto']:,.2f}")
                cc2.metric("Entrada", f"R$ {dados_pag['valor_entrada']:,.2f}")
                cc3.metric(
        ...
        with subtab2:
            ...
            if pagamentos:
                ...
                df_pag_display = df_pag[[
                    "id","numero_os","nome_cliente","valor_produto",
                    "valor_entrada","valor_saldo","tipo_pagamento",
                    "arquivo_comprovante","data_hora_registro",
                ]].rename(columns={
                    "id":"ID","numero_os":"Nº OS","nome_cliente":"Cliente",
                    "valor_produto":"Valor Produto (R$)","valor_entrada":"Entrada (R$)",
                ...
                if reg_pag:
                    with st.form(f"form_edit_pag_{id_edit_pag}"):
                        ...
                        with ep2:
                            ep_det = st.text_area("Detalhe do Pedido", value=reg_pag.get("detalhe_pedido", ""), height=80)
